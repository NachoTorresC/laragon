    ...
    if (isset($_POST['enviar']) && !empty($_POST['pedido'])) {
        ...
        if ($idRepetida == false) {//Si el id del pedido no existe creamos el pedido nuevo
            ...
            VALUES (:idPedido,:idCliente,:fechaPedido,:fechaEntrega, :fechaEnvio,:totalPedido)");
                ...
                //Visualizo el resultado del pedido
                echo "\n<p><b>Resumen de pedido ID:$idPedido</b></p><br>
                <ul><li>Fecha del pedido: $fechaPedido</li></ul>
                <ul><li>Fecha de envio: $fechaEnvio</li></ul>
                <ul><li>Fecha de entrega: $fechaEntrega</li></ul>
                <ul><li>Precio: $totalPedido"."€</li></ul>
