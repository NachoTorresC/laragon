    ...
    <div class="container self-center flex flex-wrap mt-20 p-8 ">
        <div class="grid col-12  gap-4 w-full" >
            <div class="flex justify-center flex-col">
                <img style="max-width:200px" class="self-center border-solid border-4 border-black " src="/images/{{$curso->Imagen}}" >
            </div>
            <div class="col-12 grid gap-y-9">
                ...
                <div class="enlaceDescarga text-center">
                    <a class=" btn bg-btn btn-m text-white " href="{{url('cursos/download', $curso->id)}}">Descargar</a>
                </div>
